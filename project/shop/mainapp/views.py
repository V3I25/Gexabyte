...
class CheckoutView(CartMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        stripe.api_key = 'sk_test_51IpTXxH7ZdDIsv09JeB6P7tKQvyty5wPVBfQXtQf5ys0NQJeUSEvKpcLJIGTezhUV7DTExdmZlbBCugWvUdu271Q00hoGeu3p7'
        intent = stripe.PaymentIntent.create(
            amount = self.cart.final_price * 100,
            currency = 'kzt',
